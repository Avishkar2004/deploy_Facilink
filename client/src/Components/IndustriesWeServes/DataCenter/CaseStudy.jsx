...
import ManufacturingCaseStudy1 from "../../../assets/CaseStudies/new-case-study2.jpg";
import Slider from 'react-slick';

const caseStudy = [
    {
        id: 1,
        img: ManufacturingCaseStudy,
        title: "FacilinkManufacturing Solutions is providing project and program management to bring a state-of-the-art, manufacturing facility online and fully operational in record time. Value Delivered: The facility was operational in just 2 months, allowing the client to realize 33% of their project return seven months ahead of schedule."
    },
    {
        id: 2,
        img: ManufacturingCaseStudy1,
        title: "FacilinkManufacturing Solutions is providing project and program management to bring a state-of-the-art, manufacturing facility online and fully operational in record time. Value Delivered: The facility was operational in just 2 months, allowing the client to realize 33% of their project return seven months ahead of schedule."
    }
];
